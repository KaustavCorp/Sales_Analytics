...
# Go up three levels from current file to opt\airflow level
...
RELATIVE_BASE_PATH = os.getenv("SALES_DATA_SOURCE")
BASE_PATH = os.path.join(project_root, RELATIVE_BASE_PATH)
